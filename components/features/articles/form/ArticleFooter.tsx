...
export default function ArticleFooter({ isSubmitting, isValid, onSubmit }: ArticleFooterProps) {
    return (
        <footer className="flex justify-center pt-10">
            ...
            >
                <span className="uppercase tracking-[0.2em] text-sm">Publicar Artículo</span>
                {isSubmitting ? (
