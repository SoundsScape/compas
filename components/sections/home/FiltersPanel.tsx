...
export function FiltersPanel({
    ...
    return (
        <div
            className={`pointer-events-auto fixed top-20 left-4 z-10 flex items-start gap-1 transition-all duration-300 print:hidden ${showFilters ? '-translate-x-[290px] lg:-translate-x-[385px] 2xl:-translate-x-[458px]' : 'translate-x-0'}`}
        >
            <div
